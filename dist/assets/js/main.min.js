 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */if(true){(function(){'use strict';var _assign=__webpack_require__(/*! object-assign */ "./node_modules/object-assign/index.js");// TODO: this is special because it gets imported during build.
...
/***/ "./src/es/jsx/app/ExampleComponent.jsx":
/*!*********************************************!*\
  !*** ./src/es/jsx/app/ExampleComponent.jsx ***!
  \*********************************************/
...
const ExampleComponent=()=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1",null,"Startify3"));};
...
/* harmony export */ });
function IsLegacyIE(){const currentUserAgent=window.navigator.userAgent.toLowerCase(),notice='ご利用のウェブブラウザでは当サイトを正常に閲覧できません。ブラウザのバージョンを最新にして再度アクセスしてください。',targets=['msie 6.0',// Internet Explorer 6
'msie 7.0',// Internet Explorer 7
'msie 8.0',// Internet Explorer 8
'msie 9.0',// Internet Explorer 9
'msie 10.0',// Internet Explorer 10
'trident/7.0'// Internet Explorer 11
];Array.prototype.slice.call(targets).forEach(target=>{if(currentUserAgent.indexOf(target)!==-1){alert(notice);}else{return false;}});}
...
/* harmony export */ });
class IntersectionObserverToggleClass{constructor(settings){this.selector=settings.selector;this.className=settings.className;this.toggle=settings.toggle;this.doObserve=element=>{const targets=document.querySelectorAll(element);const options={root:null,rootMargin:'0px',threshold:0};const observer=new IntersectionObserver(items=>{items.forEach(item=>{if(this.toggle){if(item.isIntersecting){item.target.classList.add(this.className);}else{item.target.classList.remove(this.className);}}else{if(item.isIntersecting){item.target.classList.add(this.className);}}});},options);Array.from(targets).forEach(target=>{observer.observe(target);});};this.doObserve(this.selector);}}
...
/* harmony import */ var _jsx_app_ExampleComponent_jsx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./jsx/app/ExampleComponent.jsx */ "./src/es/jsx/app/ExampleComponent.jsx");
// stylesheet import
// import '../scss/main.scss';
// React
const App=()=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_jsx_app_ExampleComponent_jsx__WEBPACK_IMPORTED_MODULE_7__.ExampleComponent,null));};react_dom__WEBPACK_IMPORTED_MODULE_2__.render(/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(App,null),document.getElementById('app'));// Intersection Observer
